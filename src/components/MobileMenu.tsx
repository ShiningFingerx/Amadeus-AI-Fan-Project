    ...
    <div className="fixed inset-0 z-40 lg:hidden">
      ...
      <div className="relative h-full w-full max-w-xs glass-panel flex flex-col animate-slide-in-left">
        ...
        <div className="flex-grow p-4 overflow-y-auto scrollbar-thin-amber space-y-4">
            ...
            <button
                onClick={onOpenLogs}
                className="w-full flex items-center justify-center gap-2 py-3 px-4 border border-red-500/40 text-red-400/70 rounded-md hover:bg-red-500/20 hover:text-red-300 transition-colors duration-300 font-orbitron tracking-wider text-[10px]"
            >
