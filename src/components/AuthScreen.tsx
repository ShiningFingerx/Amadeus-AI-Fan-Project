    ...
    <div className="group relative flex flex-col gap-1.5 w-full mb-6">
        ...
        <div className="relative">
            <input
                ...
                disabled={disabled}
                className={`w-full bg-slate-950/40 border border-white/5 border-l-2 py-4 px-5 font-roboto-mono text-sm outline-none transition-all backdrop-blur-sm ${isKey ? 'border-l-red-600/50 focus:border-l-red-500 focus:bg-red-500/5' : 'border-l-amber-600/50 focus:border-l-amber-500 focus:bg-amber-500/5'} text-white placeholder-white/10`}
            />
